...
3. **手动清理**：
   ...
   taskkill /f /im python.exe /fi "WINDOWTITLE eq *mcp-feedback-enhanced-pro*"
...
**原因**：频繁使用 `uvx --prerelease=allow mcp-feedback-enhanced-pro@latest`
...
如果遇到清理问题，请：
1. 查看本文档的故障排除部分
2. 在 [GitHub Issues](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/issues) 报告问题
3. 提供错误信息和系统信息
