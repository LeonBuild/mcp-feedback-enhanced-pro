...
def load_user_layout_settings() -> str:
    ...
    try:
        # 使用統一的設定檔案路徑
        config_dir = Path.home() / ".config" / "mcp-feedback-enhanced-pro"
    ...
    async def index(request: Request):
        ...
        if not current_session:
            ...
            return manager.templates.TemplateResponse(
                ...
                {
                    "request": request,
                    "title": f"MCP Feedback Enhanced Pro v{__version__}",
                    "has_session": False,
                    "version": __version__,
                },
            )
        ...
        return manager.templates.TemplateResponse(
            "feedback.html",
            {
                ...
                "title": f"MCP Feedback Enhanced Pro v{__version__} - 回饋收集",
                "version": __version__,
                "has_session": True,
