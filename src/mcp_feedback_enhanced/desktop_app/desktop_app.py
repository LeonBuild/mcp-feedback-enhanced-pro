...
class DesktopApp:
    ...
    async def launch_tauri_app(self, server_url: str):
        ...
        try:
            ...
            # 定義平台到二進制文件的映射
            if system == "windows":
                tauri_exe = desktop_dir / "mcp-feedback-enhanced-pro-desktop.exe"
                ...
                if machine in ["arm64", "aarch64"]:
                    ...
                    tauri_exe = (
                        desktop_dir / "mcp-feedback-enhanced-pro-desktop-macos-intel"
                    )
            elif system == "linux":
                tauri_exe = desktop_dir / "mcp-feedback-enhanced-pro-desktop-linux"
            else:
                # 回退到通用名稱
                tauri_exe = desktop_dir / "mcp-feedback-enhanced-pro-desktop"
            ...
            if tauri_exe.exists():
                ...
                # 嘗試回退選項
                fallback_files = [
                    desktop_dir / "mcp-feedback-enhanced-pro-desktop.exe",
                    desktop_dir / "mcp-feedback-enhanced-pro-desktop-macos-intel",
                    desktop_dir / "mcp-feedback-enhanced-pro-desktop-macos-arm64",
            ...
            tauri_exe = (
                ...
                / "target"
                / "debug"
                / "mcp-feedback-enhanced-pro-desktop.exe"
            )
