...
### 🔄 Workflow
1. **AI Call** → `mcp-feedback-enhanced-pro` tool
...
follow mcp-feedback-enhanced-pro instructions
```
...
uvx --no-cache --with-editable . mcp-feedback-enhanced-pro test --web   # Web UI testing (continuous running)
uvx --no-cache --with-editable . mcp-feedback-enhanced-pro test --desktop # Desktop application testing
...
### Latest Version Highlights (v3.0.2)
...
- 🎯 Auto-focus input box feature ([PR #39](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/39))

**leo108** - [GitHub @leo108](https://github.com/leo108)
- 🌐 SSH Remote Development Support (`MCP_WEB_HOST` environment variable) ([PR #113](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/113))

**Alsan** - [GitHub @Alsan](https://github.com/Alsan)
- 🍎 macOS PyO3 Compilation Configuration Support ([PR #93](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/93))

**fireinice** - [GitHub @fireinice](https://github.com/fireinice)
- 📝 Tool Documentation Optimization (LLM instructions moved to docstring) ([PR #105](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/105))
