...
### 🔄 工作流程
1. **AI 调用** → `mcp-feedback-enhanced-pro` 工具
...
注意在任务完成前根据mcp-feedback-enhanced-pro工具的要求进行工具调用
```
...
```bash
# 版本查询
uvx --prerelease=allow mcp-feedback-enhanced-pro@latest version       # 检查版本

# 界面测试
uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test --web    # 测试 Web UI (自动持续运行)
uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test --desktop # 测试桌面应用程序 (v2.5.0 新功能)

# 调试模式
MCP_DEBUG=true uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test

# 指定语言测试
MCP_LANGUAGE=en uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test --web    # 强制使用英文界面
MCP_LANGUAGE=zh-TW uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test --web  # 强制使用繁体中文
MCP_LANGUAGE=zh-CN uvx --prerelease=allow mcp-feedback-enhanced-pro@latest test --web  # 强制使用简体中文
```

### 开发者安装
```bash
git clone https://github.com/LeonBuild/mcp-feedback-enhanced-pro.git
cd mcp-feedback-enhanced-pro
uv sync
```
...
uvx --no-cache --with-editable . mcp-feedback-enhanced-pro test --web   # Web UI 测试 (持续运行)
uvx --no-cache --with-editable . mcp-feedback-enhanced-pro test --desktop # 桌面应用测试
...
### 最新版本亮点（v3.0.0）
- 📦 **包名与命令统一**：统一为 `mcp-feedback-enhanced-pro`，可直接使用 `uvx --prerelease=allow mcp-feedback-enhanced-pro@latest`
...
A: v2.4.0 版本已完全移除 PyQt6 GUI 依赖。如需使用旧版 GUI，请指定 v2.3.0 或更早版本：`uvx --prerelease=allow mcp-feedback-enhanced-pro@2.3.0`
...
**Q: 中文字符乱码**
A: 已在 v2.0.3 修复。更新到最新版本：`uvx --prerelease=allow mcp-feedback-enhanced-pro@latest`
...
- 🎯 自动聚焦输入框功能 ([PR #39](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/39))

**leo108** - [GitHub @leo108](https://github.com/leo108)
- 🌐 SSH 远程开发支持 (`MCP_WEB_HOST` 环境变量) ([PR #113](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/113))

**Alsan** - [GitHub @Alsan](https://github.com/Alsan)
- 🍎 macOS PyO3 编译配置支持 ([PR #93](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/93))

**fireinice** - [GitHub @fireinice](https://github.com/fireinice)
- 📝 工具文档优化 (LLM 指令移至 docstring) ([PR #105](https://github.com/LeonBuild/mcp-feedback-enhanced-pro/pull/105))
...
[![Star History Chart](https://api.star-history.com/svg?repos=LeonBuild/mcp-feedback-enhanced-pro&type=Date)](https://star-history.com/#LeonBuild/mcp-feedback-enhanced-pro&Date)
